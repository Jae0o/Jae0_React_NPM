...
const meta = {
  ...
  argTypes: {
    ...
    backgroundStyle: {
      control: { disable: true },
      description: "Modal의 background의 스타일을 변경하기 위해 `CSS style` 값을 전달받습니다.",
    },
    modalStyle: {
      control: { disable: true },
      description: "Modal의 스타일을 변경하기 위해 `CSS style` 값을 전달받습니다.",
    },

    zIndex: {
      control: "number",
      description: "필요한 경우 Modal의 `z-index` 값을 제어하기 위해 사용할 수 있습니다.",
    },
  },
    ...
    (ModalComponent, { args }) => {
      ...
      return (
        <>
          ...
          <ModalComponent args={{ ...args, isShow, onClose: handleCloseModal }} />
        </>
      );
    },
  ],
